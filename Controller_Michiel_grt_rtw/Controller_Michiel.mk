###########################################################################
## Makefile generated for Simulink model 'Controller_Michiel'. 
## 
## Makefile     : Controller_Michiel.mk
## Generated on : Thu Mar 31 20:39:45 2016
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Controller_Michiel
...
PRODUCT_NAME              = Controller_Michiel
MAKEFILE                  = Controller_Michiel.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/MVdB/Desktop/FEB
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Controller_Michiel_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controller_Michiel
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Controller_Michiel_grt_rtw -I$(START_DIR) -I$(START_DIR)/Torque\ vectoring -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Controller_Michiel -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/Controller_Michiel_grt_rtw/Controller_Michiel.c $(START_DIR)/Controller_Michiel_grt_rtw/Controller_Michiel_data.c $(START_DIR)/Controller_Michiel_grt_rtw/rtGetInf.c $(START_DIR)/Controller_Michiel_grt_rtw/rtGetNaN.c $(START_DIR)/Controller_Michiel_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Controller_Michiel.o Controller_Michiel_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_logging.o
...
%.o : $(START_DIR)/Controller_Michiel_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Controller_Michiel_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
