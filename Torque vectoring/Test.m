...
Kwf     =0;                 %Stijfheid banden vooraan (Formule van maken)
Kwr     =0;                 %Stijfheid banden achteraan (Formule van maken)
...
LR = -0.0237*(Vzwp)^2 + 0.0958*Vzwp;                    %Formule achter moet nog nagekeken worden
...
%Maximum torques op banden
Trl_max = Fx_rl*Reff;
Trr_max = Fx_rr*Reff;

%Maximum torques motoren
Trl_eng = Trl_max/Gr;
Trr_eng = Trr_max/Gr;